...
import GoodSwiper from '../../../components/goodSwiper/GoodSwiper';
        ...
        return (
            <div className="home">
                ...
                <section className="home-policy">
                    <PolicyList policyList={['网易自营品牌', '30天无忧退货', '48小时快速退款']}/>
                </section>
